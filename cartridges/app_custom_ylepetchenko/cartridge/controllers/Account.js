...
server.post(
    ...
    function (req, res, next) {
        ...
        var registrationFormObj = {
            ...
            hobby: registrationForm.customer.hobby.value,
            petname: registrationForm.customer.petname.value,
                    ...
                    try {
                        Transaction.wrap(function () {
                            ...
                            if (!authenticatedCustomer) {
                                ...
                                newCustomerProfile.custom.hobby = registrationForm.hobby;
                                newCustomerProfile.custom.petname = registrationForm.petname;
                            }
                        });
                    } catch (e) {
                        if (e.authError) {
...
server.get(
    ...
    function (req, res, next) {
        ...
        profileForm.customer.hobby.value = accountModel.profile.hobby;
        profileForm.customer.petname.value = accountModel.profile.petname;
...
server.post(
    ...
    function (req, res, next) {
        ...
        var result = {
            ...
            hobby: profileForm.customer.hobby.value,
            petname: profileForm.customer.petname.value,
            profileForm: profileForm
        };
