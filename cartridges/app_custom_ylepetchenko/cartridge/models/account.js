...
function getProfile(profile) {
    ...
    if (profile) {
        result = {
            ...
            phone: Object.prototype.hasOwnProperty.call(profile.profile, 'phone') ? profile.profile.phone : profile.profile.phoneHome,
            password: '********',
            hobby: profile.profile.custom.hobby,
            petname: profile.profile.custom.petname
        };
    } else {
        result = null;
    }
...
function account(currentCustomer, addressModel, orderModel) {
    this.profile = getProfile(currentCustomer.raw);
